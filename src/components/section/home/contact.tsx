const Contact = () => {
  return (
    <section className="space-y-10 my-lg-14 my-8 py-12 px-5 md:px-12 lg:px-24 bg-gray-100">
      <div className="container lg:px-6  mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-6">
          ...
          <div className="mt-8 lg:w-1/2 lg:mx-6">
            <div className="w-full px-8 py-10 lg:mx-auto overflow-hidden bg-white rounded-lg  shadow-2xl dark:bg-gray-900 lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
